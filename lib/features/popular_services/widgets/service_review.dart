  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Column(
        children: [
          ...List.generate(
            controller.serviceSelected.value.reviews.length,
            (index) => Container(
              margin:
              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          ...
                          CircleAvatar(
                            ...
                            backgroundImage: CachedNetworkImageProvider(
                              controller
                                  .serviceSelected.value.reviews[index].avatar,
                            ),
                  ...
                  // Text
                  Text(
                    controller.serviceSelected.value.reviews[index].comment,
                    maxLines: 3,
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      Text(
                        controller.serviceSelected.value.reviews[index].rating
                            .toString(),
